...
/*===========================================================
   メモ
   Mode1 : 探索走行　0.5s 直進加速無し
   Mode2 : 最短走行　0.5s 直進加速有り　1段目
   Mode3 : 最短走行　0.5s 直進加速有り　2段目
   Mode4 : 最短走行　0.4s 直進加速有り
   Mode5 : 最短走行　0.35s 直進加速有り
============================================================*/
...
#define CTRL_MODE1  1.5
#define CTRL_MODE2  1.0
#define CTRL_MODE3  0.6
#define CTRL_MODE4  0.4
